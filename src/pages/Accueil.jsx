...
import { FaLeaf, FaUser, FaStore, FaSeedling, FaShoppingBasket, FaHandsHelping, FaArrowRight,FaChevronLeft, FaChevronRight } from "react-icons/fa";
import Navigation from "../components/Navigation";
import { useEffect } from 'react';
import products from "../data/products";
import { useState } from "react";
import heroImage from '../assets/logo.jpeg'; // Adaptez le chemin selon votre structure
...
const Accueil = () => {
  ...
  return (
    <Container>
      ...
      <Section id="accueil">
        ...
        <ButtonContainer>
          <Button primary onClick={() => navigate("/connexion_agriculteur")}>
            <FaUser /> Je suis un agriculteur
          </Button>
  ...
  <FeatureIcon className="feature-icon"><FaSeedling /></FeatureIcon>
  <h3>Production Locale</h3>
  <p>Des produits cultivés près de chez vous avec des méthodes respectueuses de l'environnement et une traçabilité totale.</p>
</FeatureCard>
          <FeatureCard delay="0.4s">
            <FeatureIcon><FaShoppingBasket /></FeatureIcon>
            <h3>Marché Direct</h3>
            <p>Achetez sans intermédiaires pour des prix justes et une rémunération équitable des producteurs locaux.</p>
          </FeatureCard>
          
          <FeatureCard delay="0.6s">
            <FeatureIcon><FaHandsHelping /></FeatureIcon>
            <h3>Communauté</h3>
            <p>Rejoignez un réseau de consommateurs engagés et de producteurs passionnés par une agriculture responsable.</p>
          </FeatureCard>
        </FeaturesGrid>
      </Section>
