  ...
  return (
    ...
    >
      <Form onSubmit={handleSubmit}>
        ...
        {/* Ligne 3 - Superficie et Type de culture */}
        <Row>
          <InputGroup>
            <Label>Superficie (hectares)</Label>
            <InputIcon><FaTractor /></InputIcon>
            <Input 
              type="number" 
              name="superficie"
              placeholder="10" 
          ...
          <InputGroup>
            <Label>Type de culture principale</Label>
            <InputIcon><FaLeaf /></InputIcon>
            <Input 
              type="text" 
              name="typeCulture"
              placeholder="Céréales, maraîchage, etc." 
              required
        ...
        <SubmitButton type="submit">
          <FaLeaf /> S'inscrire comme Agriculteur
        </SubmitButton>

        <LoginLink>
          Vous avez déjà un compte ?
          <Link to="/connexion_agriculteur">Connectez-vous</Link>
        </LoginLink>
      </Form>
    </AuthLayout>
  );
